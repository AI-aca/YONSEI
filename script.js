...
1) 잘한 점 (2문장)
2) 미흡한 점 또는 약점 (1문장)
   - 세부 영역 데이터(세부 영역별 점수, 오답 문항)가 있는 경우에만: 취약 세부 영역 명시 (예: "시제 영역에서 0/20점으로 집중 감점되었습니다")
   - 세부 영역 데이터가 없는 경우: 총점과 반 평균 비교만으로 서술. 세부 유형·문법 항목·문제 유형 절대 추측·지어내지 말 것
3) 구체적 학습 방향 제시 (1문장)
...
- 학원명, 교재명, 브랜드명 절대 금지. 모든 답변은 순수 한국어로 작성하세요.
- 🚨 세부 영역 데이터가 제공되지 않은 경우, 세부 유형·문항 유형·문법 항목을 절대 지어내거나 추측하지 마세요.`;
