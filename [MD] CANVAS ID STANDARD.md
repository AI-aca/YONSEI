...
| **04** | 설정 접근 인증 | `renderAuthScreen` | 마스터 비밀번호 입력 → 성공 시 캔버스11(주요사항 설정)로 직접 이동 (최상단 '설정' 클릭) |
...
| **07** | 문항 및 학생 통계 | `renderStats` | 시험지별 문항 난이도/유형 통계 대시보드 |
...
| **11** | 주요사항 설정 | `renderMainConfig` | 서버 URL, API Key, 로고 등 핵심 설정 관리 |
